...
links:
  - title: How Great Leaders Navigate Uncertainty
    ...
    minutes: 6
  - title: The Difference Between Risk and Uncertainty in Leadership
    url: 'https://hbr.org/2023/04/managing-the-tension-between-performance-and-learning'
    minutes: 5
related:
  - cynefin
...
<!-- image: /images/cards/leadership-uncertainty-matrix/the-matrix.png -->
...
1. **Name the reality.** Ask honestly: is the path forward clear, or genuinely unknown? Resist the urge to treat your current feelings as the answer.
2. **Check your default mode.** Under pressure, which quadrant do you tend toward? Is it serving the situation?
3. **Adjust your communication.** In indeterminate situations, talk about learning and experiments. In determinate ones, talk about direction and execution.
4. **Watch for drift.** Situations shift over time. A product launch that starts in Exploratory Vision should migrate toward Confident Execution once a direction becomes clear.
