...
<!-- image: /images/cards/assumption-map/matrix-certaintyrisk.png -->

**Make a matrix** with certainty and risk on the axes.

**Map each assumption**, asking the group:

-   _How bad would it be if we were wrong about this?_
-   _How sure are we about this?_

**Tip**: _suggest that the group compare assumptions with each other to find the right quadrant faster._

Perform this until you have all your assumptions on the map.

## 🔎 High risk and low certainty

<!-- image: /images/cards/assumption-map/high-risk-and-low-certainty.png -->
...
<!-- image: /images/cards/assumption-map/high-risk-and-high-certainty.png -->
...
<!-- image: /images/cards/assumption-map/low-risk-and-high-certainty.png -->
...
<!-- image: /images/cards/assumption-map/low-risk-and-low-certainty.png -->
