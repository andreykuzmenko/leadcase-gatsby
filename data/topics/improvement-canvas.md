...
metaDescription: The Improvement Canvas walks a team from the current state to a shared vision and first concrete actions, making problem-solving practical.
topicType: Workshop
tags:
  - problem-solving
links:
...
**_Tip_**_: if you have trouble clearly articulating the topic, start by describing the current state and then return to defining the topic._
...
For example: _"In 6 weeks, we have achieved the following:..."_ followed by a list of statements describing what has changed. The criteria should be clear and easily measurable.

For example: _"Within a week, we have no customer complaints."_
