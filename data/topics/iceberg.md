...
<!-- image: /images/cards/iceberg/the-essence-of-the-idea.png -->
...
**The event level** is the level at which we usually perceive the world. _For example, waking up one morning and finding out we have caught a cold._
...
Looking just below the surface of events, we often see patterns. Such events have been repeated in the past. _Perhaps we catch colds more often when we don't get enough rest._ Observing patterns can help us to predict and anticipate events.

### Questions to ask:

1.  What patterns/regularities can be seen?
...
_Increased stress at work due to a new promotion policy, eating unhealthy under stress habits, or an inconvenient location for healthy food sources. All of these may be factors influencing our cold._
...
1.  What can explain the patterns?
2.  What is the connection between the patterns and the structures?
...
_Mental models involved in colds and flu may include: the belief that career is very important to our identity, that healthy food is too expensive, or that rest is for the unmotivated._

### Questions to ask:

1.  What attitudes, values, and beliefs do people hold about the system?
2.  What beliefs support the system?
...
1.  **Event Level.** _Many bugs were found in the latest release._
2.  **Pattern Level.** _The situation was the same in previous releases._
3.  **Structure Level.** _Little time left for testing and constant rushing with releases._
4.  **Mental Models Level.** _Quality is less important than released products._
